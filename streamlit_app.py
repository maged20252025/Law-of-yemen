...
# أسهم التنقل العائمة إلى الجهة اليسرى
st.markdown("""
<style>
.scroll-btn {
    position: fixed;
...
<button class="scroll-btn" id="scroll-top-btn" onclick="scrollToTop()">⬆️</button>
<button class="scroll-btn" id="scroll-bottom-btn" onclick="scrollToBottom()">⬇️</button>
