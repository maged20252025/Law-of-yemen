...
def run_main_app():
    ...
    if st.button("🔍 بدء البحث") and keywords:
        ...
        for file in search_files:
            ...
            current_article_num = "غير معروفة"
            ...
            for para in doc.paragraphs:
                ...
                # إذا بدأ السطر بكلمة مادة، نستخرج الرقم ونحدث رقم المادة الحالية
                article_match = re.search(r"مادة\s*\(?\s*(\d+)", txt)
                if article_match:
